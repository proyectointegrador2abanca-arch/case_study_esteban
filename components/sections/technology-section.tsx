...
const sideImages = [
  {
    ...
    alt: "Le Marais district Paris",
    position: "left",
    span: 1,
  },
  {
    src: "/imagenes_extraidas_pdf/img58.jpg",
    alt: "Parisian covered passage",
    position: "left",
    span: 1,
  },
  {
    src: "/imagenes_extraidas_pdf/img62.jpg",
    alt: "La Defense modern district",
    position: "right",
    span: 1,
  },
  {
      ...
      <div className="sticky top-0 h-screen overflow-hidden">
        <div className="flex h-full w-full items-center justify-center">
          ...
          >
            ...
            >
              <Image
                src="/imagenes_extraidas_pdf/img64.jpg"
                alt="Aerial view of Paris at blue hour"
                fill
                className="object-cover"
              />
              ...
              >
                <h2 className="max-w-3xl font-medium leading-tight tracking-tight text-white md:text-5xl lg:text-7xl text-5xl">
                  {["Urban", "Heritage", "&", "Transformation."].map((word, index) => {
                    // Each word fades out sequentially based on scrollProgress
                    const wordFadeStart = index * 0.05; // Slightly faster for 4 words
